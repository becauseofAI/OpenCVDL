...
int main(int argc, char **argv)
{
    CommandLineParser parser(argc, argv,
        ...
        "{ p proto          |../../../model/caffe/openpose/openpose_pose_coco.prototxt| (required) model configuration, e.g. hand/pose.prototxt }"
        "{ m model          |../../../model/caffe/openpose/pose_iter_440000.caffemodel| (required) model weights, e.g. hand/pose_iter_102000.caffemodel }"
        "{ i image          |../../../data/Michael_Jordan.jpg | (required) path to image file (containing a single person, or hand) }"
	...
	imwrite("Michael_Jordan_Pose_Cpp.jpg", img);
    imshow("OpenPose", img);
    waitKey();
